...
public class NimGame implements Interfacetypes {
	...
	public NimGame (int n) throws IOException {
                this.n = n;
		finalturn = null;
		divisoresN(n);
		game();      
	...
	private void divisoresN (int n) {
		ArrayList<Integer> Stacks = cargarDivisores(n);
		this.firststate=new State(Stacks);
	}  

        private ArrayList<Integer> cargarDivisores(int n){
